...
class PersonServiceTest {
	...
	void testFindById() {
		...
		assertEquals(result.toString(), "links: [</person/v1/1>;rel=\"self\"]");
	...
	void testFindAll() {
		...
		assertEquals(personOne.toString(), "links: [</person/v1/1>;rel=\"self\"]");
		...
		assertEquals(personFour.toString(), "links: [</person/v1/4>;rel=\"self\"]");
		...
		assertEquals(personSeven.toString(), "links: [</person/v1/7>;rel=\"self\"]");
