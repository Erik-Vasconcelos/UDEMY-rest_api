...
public class CustomExceptionHandler extends ResponseEntityExceptionHandler {
	...
	public ResponseEntity<ExceptionReponse> objectIsNull(Exception ex, WebRequest request) {
		ExceptionReponse reponse = new ExceptionReponse(HttpStatus.BAD_REQUEST.value(), ex.getMessage(),
				request.getDescription(false), Instant.now());
	...
	public ResponseEntity<ExceptionReponse> invalidToken(Exception ex, WebRequest request) {
		ExceptionReponse reponse = new ExceptionReponse(HttpStatus.FORBIDDEN.value(), ex.getMessage(),
				request.getDescription(false), Instant.now());
